...
# coding=UTF-8
#
# Generated by pykdeuic4 from ui/ui_scrFolder.ui on Sat Aug  4 00:00:25 2012
#
...
"}"))
        ...
        self.pictureFolderButton = QtGui.QToolButton(self.groupBoxFolders)
        icon = QtGui.QIcon.fromTheme(_fromUtf8("folder-image"))
        self.pictureFolderButton.setIcon(icon)
        self.pictureFolderButton.setIconSize(QtCore.QSize(64, 64))
        self.pictureFolderButton.setCheckable(True)
        self.pictureFolderButton.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.pictureFolderButton.setObjectName(_fromUtf8("pictureFolderButton"))
        self.horizontalLayout_3.addWidget(self.pictureFolderButton)
        ...
        self.screen_icon = QtGui.QLabel(folderWidget)
        self.screen_icon.setMinimumSize(QtCore.QSize(64, 64))
        self.screen_icon.setMaximumSize(QtCore.QSize(64, 64))
        self.screen_icon.setSizeIncrement(QtCore.QSize(0, 0))
        self.screen_icon.setText(_fromUtf8(""))
        self.screen_icon.setPixmap(QtGui.QPixmap(_fromUtf8("../../../../../../usr/share/icons/oxygen/64x64/places/folder-bookmark.png")))
        self.screen_icon.setObjectName(_fromUtf8("screen_icon"))
        self.horizontalLayout_2.addWidget(self.screen_icon)
...
"border-top-right-radius: 4px;"))
    ...
    def retranslateUi(self, folderWidget):
        ...
        self.description.setText(kdecore.i18n(_fromUtf8("""<html><head/><body><p>
                        Your home directory does not contain folders for
                        documents, music, pictures and the like by
                        default. Kapudan will create the folders
                        selected below for you now; unselect the ones
                        you don\'t want.</p></body></html>""")))
