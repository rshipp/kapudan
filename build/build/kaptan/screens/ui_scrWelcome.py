...
# coding=UTF-8
#
# Generated by pykdeuic4 from ui/ui_scrWelcome.ui on Fri May 25 10:27:24 2012
#
...
class Ui_welcomeWidget(object):
    ...
    def retranslateUi(self, welcomeWidget):
        ...
        self.label_3.setText(kdecore.i18n(_fromUtf8("What is Chakra?")))
        self.description.setText(kdecore.i18n(_fromUtf8("<html><head/><body><p><span style=\" font-weight:600;\">Chakra</span> brings a ground-up Linux distribution, a free software showcase project created by a bunch of people who like the KISS principles, the elegance of the Plasma Desktop and a bundlesystem to support well known Gtk applications.<br/><br/>Our main goal is provide a fast, user-friendly and extremely powerful Live CD and/or Linux distribution specially made for the award winning KDE Software Compilation and the beautiful Plasma desktop.<br/><br/><span style=\" font-weight:600;\">Kaptan</span> will help you personalize your Chakra workspace easily and quickly. Please click <span style=\" font-weight:600;\">next</span> in order to begin.</p></body></html>")))
