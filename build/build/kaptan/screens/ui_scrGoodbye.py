...
# coding=UTF-8
#
# Generated by pykdeuic4 from ui/ui_scrGoodbye.ui on Fri May 25 10:37:58 2012
#
...
class Ui_goodbyeWidget(object):
    def setupUi(self, goodbyeWidget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 589, 659))
...
"}"))
    ...
    def retranslateUi(self, goodbyeWidget):
        ...
        self.description.setText(kdecore.i18n(_fromUtf8("<b>Your settings have been applied.</b> Now you can start enjoying Chakra or you can checkout the following links and applications for more settings or for help and support. Don\'t forget to <b>join our community!</b>")))
        self.label_3.setText(kdecore.i18n(_fromUtf8("System Settings")))
        self.labelSystemSettings.setText(kdecore.i18n(_fromUtf8("Configuration tools for Chakra such as the display, firewall, keyboard, user manager...")))
        ...
        self.labelHelpPages.setText(kdecore.i18n(_fromUtf8("Chakra community, mailing lists, chat rooms, Wiki documents, help and support pages...")))
